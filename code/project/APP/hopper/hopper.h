...
/*****************************************************************************/
/*                                                                                                                                                      */
/*    Copyright (C) - WAGAIN Intelligent Equipment - All rights reserved                                                */
/*                                                                                                                                                      */
/*****************************************************************************/
/*                                                                                                                                                      */
...
/*  Date       * Author          * Changes                                                                                               */
/*****************************************************************************/
/*  2017-8-15 * xunqian.hu     * Creation of the file                                                                         */
/*             *                 *                                                                                                                    */
/*****************************************************************************/
/*  Target : stm32                                                                                                                               */
/*  Crystal: 72Mhz                                                                                                                              */
...
typedef enum            //ECU 命令常量
{
    ...
    SDP_CMD_TEST_SENSOR,//HOPPER传感器测试指令0x13
    SDP_CMD_LIMIT_QUERY,//极限参数查询的命令
    SDP_CMD_REALTIME_QUERY,//实时参数查询的命令
    SDP_CMD_HOPPER_VERSION,//HOPPER固件版本0x16
    SDP_CMD_VERSION_QUERY,//HTU 固件版本0x17
